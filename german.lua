...
L["Button Size"] = "Größe der Aktionsbuttons" --Also used in Bags
L["Button Spacing"] = "Abstand der Aktionsbuttons" --Also used in Bags
...
L['Button Size (Bag)'] = 'Tastengröße (Tasche)'
L['Button Size (Bank)'] = 'Tastengröße (Bank)'
...
L["PG"] = "PG"
L["PL"] = "PL"
L['Position of the Chat EditBox, if datatexts are disabled this will be forced to be above chat.'] = 'Position der Texteingabeleiste. Sind die Infotexte deakiviert, dann wird diese über dem Chat angebracht.'
L["Prevent the same messages from displaying in chat more than once within this set amount of seconds, set to zero to disable."] = "Verhindert das die gleiche Nachricht im Chat mehr als einmal, innerhalb dieser festgelegten Anzahl von Sekunden, angezeigt wird. Auf Null setzen zum deaktivieren."
L["R"] = "R"
...
L["The in-game configuration menu can be accesses by typing the /ec command or by clicking the 'C' button on the minimap. Press the button below if you wish to skip the installation process."] = "Das ElvUI-Konfigurationsmenü kannst du entweder mit /ec oder durch anklicken der 'C' Taste an der Minimap aufrufen. Drücke 'Schritt überspringen' um zum nächsten Schritt zu gelangen."
...
L["You can now choose what layout you wish to use based on your combat role."] = "Du kannst nun auf Basis deiner Rolle im Kapmf ein Layout wählen."
...
L["Your current resolution is %s, this is considered a %s resolution."] = "Deine Aktuelle Auflösung ist %s, diese wird als eine %s Auflösung angesehn."
...
L["Waist"] = "Taille"
L['When inside a battleground display personal scoreboard information on the main datatext bars.'] = 'Zeige innerhalb eines Schlachtfeldes perönliche Statistiken in den Haupt-Infoleisten.'
...
L["Announce when you interrupt a spell to the specified chat channel."] = "Melde über den angegebenen Chatchannel einen unterbrochenen Zauber."
...
L["Display a healer icon over known healers inside battlegrounds."] = "Zeigt in Schlachtfeldern ein Heilersymbol über Heilern an."
...
L['Display how many of a certain item you have in your possession.'] = 'Zeige wieviele sich von dem ausgewählten Gegenstand in deinem Besitz befinden.'
...
L["Tooltip"] = "Tooltip"
L["TOOLTIP_DESC"] = "Kofiguriere die Einstellungen für Tooltips."
...
L['If you accidently remove a chat frame you can always go the in-game configuration menu, press install, go to the chat portion and reset them.'] = 'Wenn du ausversehn das Chatfenster entfernen solltest, kannst du ganz einfach in die Ingame-Konfiguration gehn und den Installationsprozess erneut aufrufen. Drücke Installieren und gehe zu den Chateinstellungen und setze diese zurück.'
...
L["Color the unit healthbar if there is a debuff that can be dispelled by you."] = "Aktiviere die Hervorhebung von Einheitenfenstern, wenn ein von dir entfernbarer Schwächugnszauber vorhanden ist."
L["Color"] = "Farbe"
...
L['Create a custom fontstring. Once you enter a name you will be able to select it from the elements dropdown list.'] = 'Erstellte einen benutzerdefinierten Anzeigetext . Sobalt du einen Namen eingibst, wirst du es von der Dropdown-Liste auswählen können.'
...
L['If the unit is an enemy then this filter will be checked, otherwise it will be ignored.'] = 'Ist die Einheit ein gegnerisches Ziel, dann wird dieser Filter überprüft, andersfalls wird er ignoriert.'
...
L["Rapidly update the health, uses more memory and cpu. Only recommended for healing."] = "Schnelle Aktualisierung der Lebensleiste. Benutzt mehr Speicher und CPU. Nur für Heiler zu empfehlen."
...
L["Show a incomming heal prediction bar on the unitframe. Also display a slightly different colored bar for incoming overheals."] = "Zeige eingehende Heilung in einer Leiste auf dem Einheitenfenster. Zeigt eine etwas anders farbige Leiste für eingehende Überheilung."
...
L['The point of which you are anchoring to in relation to the attach to object.'] = 'Der Punkt, den du verankern willst,  wiederspricht sich mit dem angehefteten Objekt.'
...
L['This filter is used for both aura bars and aura icons no matter what. Its purpose is to block out specific spellids from being shown. For example a paladin can have two sacred shield buffs at once, we block out the short one.'] = 'Dieser Filter wird sowhl für für Aurenleisten und Aurensymbole verwendet. Sein Zweck besteht darin spezifische Zauber IDs zu blockieren, bevor diese angezeigt werden. Ein Beispiel für einen Paladin ist, das du zwei Geheiligter Schild Stärkungszauber auf einmal hast, wir blockieren den kürzeren.'
L["Ticks"] = "Ticks"
